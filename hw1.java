...
public class hw1 {
    public static void main(String[] args)
    {
        ...
        System.out.println(divideNew(5, 0));
    ...
    public static int divideNew(int a, int b)
    {
        if (b == 0)
        {
    ...
    public static int[] subtractionArrays(int[] arr, int[] arr2) throws RuntimeException
    {
        ...
        {
            throw new RuntimeException("Different arrays lenght!");
        }
    ...
    public static int[] divArrays(int[] arr, int[] arr2) throws RuntimeException
    {
        ...
        {
            if (arr2[i] == 0) {
                throw new RuntimeException("Zero divided!");
            }
            result[i] = arr[i] / arr2[i];
        }
        return result;
